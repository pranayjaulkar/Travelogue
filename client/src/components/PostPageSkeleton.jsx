export default function PostPageSkeleton() {
  return (
    <div className="tw-flex tw-mt-8 tw-px-4 xl:tw-px-0 tw-mx-auto tw-max-w-screen-2xl">
      <div className="tw-flex tw-w-full tw-flex-col xl:tw-w-1/2 tw-space-y-2 xl:tw-pr-6">
        <div className="xl:tw-hidden tw-animate-pulse tw-min-w-16 tw-w-full tw-h-[350px] md:tw-h-[500px] tw-bg-gray-300"></div>
        ...
        <div className="tw-animate-pulse tw-min-w-16 tw-w-full tw-h-[200px] md:tw-h-[400px] tw-bg-gray-300"></div>
        <div
          style={{ marginTop: "2.5rem" }}
          className="tw-animate-pulse tw-min-w-16 tw-w-full tw-h-[200px] tw-bg-gray-300"
        ></div>
      </div>
      <div className="tw-hidden xl:tw-flex tw-flex-col tw-w-1/2 tw-space-y-10">
